...
void sample3(){
    ...
    modint998244353 a; // using modint998244353 = static_modint<998244353>;
    modint1000000007 b; // using modint1000000007 = static_modint<1000000007>;
