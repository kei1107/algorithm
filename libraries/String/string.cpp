 ...
 *  Suffix Array sa は (0, 1, ..., n - 1) の順列であって、
 *  各 i = 0,1,...,n-2 について s[sa[i]..n) < s[sa[i+1]..n) を満たすもの。
 * 
 *  upperで s[0,...,upper] (閉区間)の指定可能
 * */
...
std::vector<int> suffix_array(const std::vector<int>& s, int upper) {
    ...
    auto sa = internal_suffix_array::sa_is(s, upper);
    return sa;
}
...
template <class T> std::vector<int> suffix_array(const std::vector<T>& s) {
    ...
    return internal_suffix_array::sa_is(s2, now);
}
...
std::vector<int> suffix_array(const std::string& s) {
    ...
    return internal_suffix_array::sa_is(s2, 255);
}
// END : suffix_array
// =============================================================== //
// =============================================================== //
 ...
 *  i 番目の要素は s[sa[i]..n), s[sa[i+1]..n) の 
...
/// Sub : Number of Substrings
/// Sの相異なる部分文字列の個数を求める
ll get_number_of_substrings(const string& s){
    ll n = s.length();
