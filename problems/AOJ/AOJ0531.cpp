...
/*
 <url:http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0531>
 問題文============================================================
 幅W()高さH()の平面を考える。この平面内にN()の矩形が存在する。
 与えられた平面は、矩形により、いくつに分割されるか求めよ。
 =================================================================
 
 解説=============================================================
 座標圧縮を行なった後に、二次元imosを行い
 全体の外形を保ったまま縮小する。その後貪欲に何個の区間に分割されているかみれば良い
 ================================================================
 */
