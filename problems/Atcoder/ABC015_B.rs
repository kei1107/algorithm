...
/*
 <url:https://beta.atcoder.jp/contests/abc015/tasks/abc015_2>
 問題文============================================================
 =================================================================
 解説=============================================================
 0出ないデータ数とその総和から平均を求める
 ================================================================
 */
fn main(){
    input!{N:usize,A:[f64;N]}
    let V:Vec<f64> = A.into_iter().filter(|&a| a != 0.0).collect();
    let Vsum:f64 = V.iter().sum();
    println!("{}",(Vsum/(V.len() as f64)).ceil());
}