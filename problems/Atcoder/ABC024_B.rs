...
/*
 <url:https://beta.atcoder.jp/contests/abc024/tasks/abc024_b>
 問題文============================================================
 =================================================================
 解説=============================================================
 zoi!!
 ...
 */
fn main(){
    input!(N:i32,T:i32,A:[i32;N]);
    let mut A:Vec<i32> = A;
    A.push(i32::max_value());
    let ans = (0..N as usize).fold(0,|sum,t| sum + min(A[t+1]-A[t],T));
    println!("{}",ans);
}