...
fn main(){
    ...
    let (bx,by):(i32,i32) = (x1,y1);
    let p1:(i32,i32) = (x1 - bx,y1 - by);
    let p2:(i32,i32) = (x2 - bx,y2 - by);

    let p3:(i32,i32) = (p2.0-p2.1,p2.0+p2.1);
    let p4:(i32,i32) = (-p2.1,p2.0);

    println!("{} {} {} {}",p3.0+bx,p3.1+by,p4.0+bx,p4.1+by);
}