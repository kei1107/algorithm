...
/*
 <url:https://beta.atcoder.jp/contests/abc109/tasks/abc109_c>
 問題文============================================================
 =================================================================
 解説=============================================================
 Xとのdiffのgcd
...
fn main(){
    input!{N:u64,X:u64,x:[u64;N]}
    let y:Vec<u64> = x.into_iter().map(|v| (max(v,X)-min(v,X))).collect();
    let GCD:u64 = y.iter().fold(y[0].clone(),|now,&v| gcd(now,v));
    println!("{}",GCD);
}