...
/*
 <url:https://beta.atcoder.jp/contests/abc110/submissions/me>
 問題文============================================================
 =================================================================
 解説=============================================================
 文字の種類は関係なく、同一種類の文字の個数がSとTで一致してればok
 ================================================================
 */
fn main(){
    input!(S:chars,T:chars);
    let mut S:Vec<char> = S;
    let mut T:Vec<char> = T;
    S.sort();
    T.sort();
    let mut cntS = vec![0;26];
    let mut cntT = vec![0;26];

    for c in S{
        cntS[c as usize - 'a' as usize]+=1;
    }
    for c in T{
        cntT[c as usize - 'a' as usize]+=1;
    }
    cntS.sort();
    cntT.sort();
    for i in 0..26{
