...
/*
 <url:https://atcoder.jp/contests/agc051/tasks/agc051_b>
 問題文============================================================
 B - Bowling 
 =================================================================
 解説=============================================================
...
Type solve(Type res = Type()){
    ...
    pii p = {1000,0},q = {5000,5000},r = {0,1};
    vector<pii> ps;
    for(int i = 0; i < 10; i++){
        for(int j = 0; j < 10; j++){
            for(int k = 0; k < 10; k++){
                int x = p.first * i + q.first * j + r.first * k;
                int y = p.second * i + q.second * j + r.second * k;

                a.emplace(x); b.emplace(x-y); c.emplace(y); d.emplace(x+y);
                ps.emplace_back(x,y);
            }
        }
    }
    ...
    cout << ps.size() << endl;
    for(auto pos:ps) cout << pos.first << " " << pos.second << endl;
    return res;
}
int main(void) {
