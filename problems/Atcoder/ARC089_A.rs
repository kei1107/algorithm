...
/*
 <url:https://beta.atcoder.jp/contests/abs/tasks/arc089_a>
 問題文============================================================
 =================================================================
 解説=============================================================
 ================================================================
...
fn main(){
    input!{N:usize, query:[[i32;3];N]}
    let mut pret = 0;
    let mut prex = 0;
    let mut prey = 0;
    let mut ok = true;
    for i in {0..N}{
        let difft = query[i][0] - pret;
        let mandist = (query[i][1] - prex).abs() + (query[i][2] - prey).abs();
        pret = query[i][0]; prex = query[i][1]; prey = query[i][2];
        if difft < mandist || (difft-mandist)%2 == 1{
            ok = false;
            break;
        }
    }
