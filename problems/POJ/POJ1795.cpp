...
/*
 <url:http://poj.org/problem?id=1795>
 問題文============================================================
 N個の文字列が与えられる。それらの文字列を全て含む文字列のうち、最短のものを求めよ。
 同じ長さの解が複数ある場合は辞書順最小のものを答えよ。
 =================================================================
 ...
 が、これで長さを求めるだけならば簡単
 問題は文字列の復元
 bitDPの結果から逆に辿っていき、遷移可能候補をみる。
 あらかじめ見ておいた遷移候補より、余分な遷移を得ないようにして文字列を復元していく
 ================================================================
 */
