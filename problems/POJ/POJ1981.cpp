...
/*
<url:http://poj.org/problem?id=1981>
問題文============================================================
平面上にN個の点が与えられたとき、半径1の円に含まれる最大個数を求める問題
=================================================================

解説=============================================================
N個のうち2点に注目する
 
 この2点を円周上に持つような円を作り、その円の内部に他に幾つのへんが入るのかを順に見ていけば良い
 
 POJだとcomplexを使うとTLEする aoj1132と同様の問題であり、aojではcomplexを利用してもtleしないため
 コードが綺麗になる
================================================================
*/
