...
/*
<url:http://poj.org/problem?id=3126>
問題文============================================================
2つの4桁の素数A, Bが与えられる．Aに対して，
「どれか一つの桁を書き換えて別の素数にする（ただし，最上位は0に書き換えてはいけない）」
 という操作を最小何回行えばBにすることができるか．
=================================================================

解説=============================================================
移動可能な素数同士にコスト１の辺をはり、A→Bへのグラフ最小距離とみなせる
================================================================
*/
