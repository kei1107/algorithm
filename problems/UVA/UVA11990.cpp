...
/*
 <url:https://vjudge.net/contest/205219#problem/Q>
 問題文============================================================
 1からNまでの数字を使った順列が与えられる。
 そこからQ個の数を順に削除する時、Q回のステップにおいて削除直前の転倒数を出力せよ。
 =================================================================
 
 解説=============================================================
 平方分割＋二次元BIT
 
 転倒数といえばbitなので転倒数を答えるのは簡単
 xを追加/削除する時に変化する転倒数は、「xより前にあるxより大きい数」と「xより後にあるxより小さい数」の合計
 
 しかし、問題は2次元空間で範囲が大きいという点
 平方分割と二次元BITを駆使して計算量を削減する
 ================================================================
 */
