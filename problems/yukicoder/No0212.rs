...
/*
 <url:https://yukicoder.me/problems/no/212>
 問題文============================================================
 =================================================================
 解説=============================================================
    期待値の線形性より、個々のサイコロが出す目の期待値の積が答え
 ================================================================
 */
fn main(){
    input!(P:f64,C:f64);
    let v1:f64 = (2.0+3.0+5.0+7.0+11.0+13.0)/6.0;
    let v2:f64 = (4.0+6.0+8.0+9.0+10.0+12.0)/6.0;
    println!("{:.12}",v1.powf(P)*v2.powf(C));
}