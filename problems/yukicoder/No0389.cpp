...
/*
 <url:https://yukicoder.me/problems/no/389>
 問題文============================================================
 =================================================================
 解説=============================================================
 
 この問題は連続する黒マスを一つの部屋とした部屋割りの問題と考えることができるので
 重複組み合わせで解ける
 ================================================================
 */
...
string solve(){
    ...
    if(H[0] == 0) return to_string(1);
    if(accumulate(H.begin(),H.end(),0LL)+H.size()-1 > M) return "NA";
    res = to_string(nHr(H.size()+1,M-accumulate(H.begin(),H.end(),0LL)-H.size()+1));
    return res;
}
int main(void) {
